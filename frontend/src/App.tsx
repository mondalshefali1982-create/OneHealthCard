...
// Route Guard for public views (Redirect logged-in users to their dashboard/portal automatically)
...
export const App: React.FC = () => {
  return (
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          {/* Public Views (Auto-redirect logged-in users to their dashboard) */}
          <Route
            path="/"
            element={
              <PublicRoute>
