...
import {
  ...
  Star, LogOut, CreditCard, Settings, FileText, ExternalLink, Globe, CheckCircle, X, Shield, Sparkles
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col md:flex-row relative text-left">
      ...
      <main className="flex-1 p-6 md:p-8 max-w-7xl mx-auto w-full overflow-y-auto">
        <div className="flex flex-col gap-8">
          ...
          {/* Hospital Photography Hero Card (Matching Medilife & WeCare Reference Images) */}
          <div className="rounded-3xl clinical-card p-6 bg-white shadow-sm border-slate-200 grid md:grid-cols-12 gap-6 items-center">
            <div className="md:col-span-4 rounded-2xl overflow-hidden shadow-md border border-slate-200 h-[150px] bg-sky-50">
              <img src="/images/clinic_interior_modern.png" alt="Modern Medical Clinic" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="md:col-span-8 flex flex-col gap-2">
              ...
              <h3 className="text-xl font-extrabold text-slate-900 m-0">Find Verified Doctors in {cityInput || 'Kolkata'}</h3>
