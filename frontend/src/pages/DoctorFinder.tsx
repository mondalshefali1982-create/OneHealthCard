    ...
    <div className="min-h-screen bg-dark-950 flex flex-col md:flex-row relative">
      ...
      <main className="flex-1 p-6 md:p-8 max-w-7xl mx-auto w-full overflow-y-auto">
        <div className="text-left flex flex-col gap-8">
          ...
          <div>
            <span className="text-xs uppercase font-bold tracking-widest text-primary-400 font-sans">REAL GOOGLE MAPS DIRECTORY</span>
            <h1 className="text-3xl font-extrabold text-white mt-1 mb-0">Doctor & Clinic Finder</h1>
            <p className="text-slate-400 text-sm">Real Google Maps doctors matching the exact map pins for your searched city.</p>
          </div>
