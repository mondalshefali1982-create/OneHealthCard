...
import { Activity, ShieldAlert, Heart, Stethoscope, User, Lock, Mail, ArrowRight, CheckCircle2, Phone, Star } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col justify-between text-left">
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8">
        <div className="max-w-6xl w-full grid lg:grid-cols-12 gap-10 items-center">
          ...
          {/* Left Side: Medical Hero Photography & Trust Features (Matching Medilife & Inymo Images) */}
          <motion.div
          ...
          >
            ...
            {/* REAL DOCTOR PHOTOGRAPHY HERO IMAGE CONTAINER */}
            <div className="relative rounded-3xl overflow-hidden shadow-xl border-2 border-white bg-sky-50 h-[240px] hidden sm:block">
              <img
                src="/images/female_doctor_hero.png"
                alt="Professional Female Doctor Hero"
                className="w-full h-full object-cover object-top"
              />
              
              {/* Floating Doctor Consultation Overlay Badge (Matching Inymo Reference Image) */}
              <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-md p-3.5 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-sky-600 shrink-0">
                ...
                <div>
                  <div className="flex items-center gap-1 text-amber-500 font-extrabold text-xs">
                    <Star className="h-3.5 w-3.5 fill-amber-500" /> 4.9★ (2,710+ Reviews)
                  </div>
                  <span className="text-[11px] font-bold text-slate-800 block">Verified Specialist Network</span>
                </div>
              </div>
            </div>

            {/* Trust Stats Bar */}
            <div className="grid grid-cols-3 gap-4 border-y border-slate-200 py-3 my-1">
              <div>
              ...
              <div>
                <span className="font-extrabold text-lg text-emerald-600 block">ISO-27001</span>
                <span className="text-xs text-slate-500 font-medium block">Secure Health Vault</span>
              </div>
            </div>
          </motion.div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            <input
                              ...
                              className="py-2 px-3 rounded-xl clinical-input text-xs font-bold text-slate-900"
                            />
                          </div>
