...
export const Dashboard: React.FC = () => {
  ...
  // Edit Form Fields
  const [editWeight, setEditWeight] = useState(profile?.weight || 0);
  const [editHeight, setEditHeight] = useState(profile?.height || 0);
  ...
  const handleDownloadCard = () => {
    // Generate a downloadable representation of the card
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      alert('Failed to save profile. Please review fields.');
    }
  };
                  ...
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-primary-600 to-teal-500 p-[1px] backface-hidden">
                    <div className="w-full h-full rounded-2xl bg-slate-900/95 p-5 flex flex-col justify-between relative overflow-hidden">
                      ...
                      <div className="flex justify-between items-end border-t border-white/5 pt-3 mt-2">
                        ...
                        {/* Hidden Canvas used to generate QR code */}
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs my-2">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-slate-300 truncate m-0">
                            {profile?.currentMedications?.join(', ') || 'None'}
                          </p>
                        </div>
                        <div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-slate-950/80 backdrop-blur-sm overflow-y-auto">
            ...
            >
              ...
              <form onSubmit={handleSaveProfile} className="flex flex-col gap-5">
                ...
                {/* Array builders (Allergies, Chronic Diseases, Meds) */}
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-400 font-bold text-primary-400">Chronic Diseases / Diagnoses</label>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-slate-400 font-bold text-teal-400">Allergies</label>
                  <div className="flex gap-2">
                    <input
                      type="text"
