...
export const Dashboard: React.FC = () => {
  ...
  // Fetch Prescriptions / Medical Timeline with live sync
  ...
  useEffect(() => {
    fetchTimeline();
    // Auto refresh timeline every 10 seconds for live doctor updates
                ...
                {loadingTimeline ? (
                  ...
                  <div className="flex flex-col gap-4 relative before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200">
                    {prescriptions.map((item, idx) => {
                      const doctorTitle = item.doctorName || 'Dr. Doctor';
